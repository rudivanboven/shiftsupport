...
const postingSections: PolicySection[] = [
  ...
  { title: "8. Off-Platform Solicitation", lead: "Retailers may not use Shift Postings to:", bullets: ["Solicit Helpers for off-platform work", "Circumvent Platform payment processes", "Collect personal contact information beyond what is necessary for the shift"], after: ["All shift-related communication must occur through the Platform unless otherwise permitted."] },
